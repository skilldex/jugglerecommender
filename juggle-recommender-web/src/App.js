 		...
 		const instructions = <SlidingPane
				                ...
				                <div className="instructions">
				                	<h2>About Skilldex</h2>
										<span className="info">
											Skilldex is an online community where you can find<br/>
											new tricks to learn, keep track of your catches, <br/>
											and share tricks with the community
										</span>
									<br/>
				                	<h2>Pattern List</h2>
									<span className="info">
										In the pattern list you are able to search, sort and filter.<br/>
										Each patterns's card has a blue arrow that can be used to<br/>
										expand the card to see the pattern demonstrated. Clicking<br/>
										anywhere else on the card will take you to it's detail page<br/>
										where more information can be seen.
									</span>
									<br/>
				                	<h2>Details Page</h2>
									<span className="info">
										On a pattern's detail page you have all the information<br/>
										about the pattern, as well as the ability to comment on it<br/>
										and suggest other tricks that are prereqs, postreqs, or<br/>
										related to it, as well as agree or disagree with the relevance<br/>
										of the other patterns that have been suggested.
									</span>
									<br/>
				                	<h2>Add Pattern</h2>
									<span className="info">
										Using this form, you  can contribute patterns to the community.<br/>
										Some fields are required, and others are optional. As the contributor<br/>
										of a pattern you have the ability to edit it later on from inside the<br/>
										details page. If the name of the pattern you are contributing is a<br/>
										valdid siteswap, then an animation of the pattern will automatically<br/>
										be generated by <a target="_" href="http://www.jugglinglab.com">www.jugglinglab.com</a>
									</span>
									<br/>
				                	<h2>Special Thanks</h2>
									<span className="info">
										We would like to than all the wonderful jugglers who have contributed<br/>
										to the site, as well as <a target="_" href="http://www.libraryofjuggling.com">libraryofjuggling.com</a> from where the site<br/>
